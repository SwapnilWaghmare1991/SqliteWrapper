...
- (void)viewDidLoad {
    ...
    [dbinst1 createTableNamed:TableEmployeeInDBEmployee usingQuery:createTableQuery1 forDatabaseNamed:DBEmployee];
    ...
    [dbinst1 performInsertUpdateDeleteOperationInDatabseNamed:DBEmployee insideTableNamed:TableEmployeeInDBEmployee withQuery:insertSQL1];
